  ...
  ghrepository: {
    ...
    async validator() {
      if (ghtoken.value !== "") {
        ...
        const repoExists = await axios.get(
          "https://api.github.com/repos/" + ghrepository.value,
          {
            headers: {
  ...
  <div class="flex flex-col p-4">
    ...
    <n-card title="GitHub" class="mb-6">
      ...
      <n-form-item
        ...
        path="ghrepository"
        size="large"
        :rule="rules.ghrepository"
      >
        <n-input
          v-model:value="ghrepository"
          placeholder="megasanjay/aigallery"
        />
    ...
    <n-card title="Database" class="mb-6">
      ...
      >
        <n-input
          v-model:value="dbkey"
          placeholder="d6e586c5e4f7ba688b26d558f8f196d9"
        />
